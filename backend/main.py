...
from api.driver_application import router as driver_application_router
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    import models.persona     # noqa: F401  # kept: migration dep only
...
app.include_router(driver_application_router)
