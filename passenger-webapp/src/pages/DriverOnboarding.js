...
export default function DriverOnboarding() {
    ...
    const driverType = (params.get('role') === 'taxi') ? 'taxi' : 'rideshare';
    ...
    function simulateScan(id) {
        if (docStatus[id] === 'scanning' || docStatus[id] === 'verified')
            return;
