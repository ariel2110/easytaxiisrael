    ...
    items: [
      {
        ...
        a: (
          <>
            בעקבות <strong>חוק שירות הנסיעות 2026</strong> (תיקון 47), מותר לנהגים פרטיים לספק שירותי הסעה בתשלום <strong>בלי רישיון מונית</strong>, בתנאים ספציפיים:
            <ul>
              ...
              <li>הגבלה של עד 30 נסיעות בחודש (לא משרה מלאה).</li>
            </ul>
            <span className="tag g">חדש 2026</span> EasyTaxi מנהלת את כל תהליך ציות החוק בשבילך.
          </>
        ),
      },
      {
        ...
        a: (
          <>
            <ul>
              <li><strong>שלב 1:</strong> כנסו ל-<a href="/driver" style={{ color: 'var(--bluel)' }}>/driver</a> ובחרו "נהג עצמאי".</li>
              <li><strong>שלב 2:</strong> אמתו את מספר הטלפון ב-WhatsApp (15 שניות).</li>
              <li><strong>שלב 3:</strong> תקבלו ב-WhatsApp קישור לאימות פנים ותעודת זהות (Persona — ~2 דקות).</li>
              <li><strong>שלב 4:</strong> לאחר אישור — תוכלו להתחיל לקבל נסיעות.</li>
            </ul>
            התהליך כולל לוקח <strong>5-7 דקות</strong>. האישור מגיע תוך 24 שעות בשעות העסקים.
          </>
        ),
      },
      {
